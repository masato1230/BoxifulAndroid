        ...
        Row(modifier = Modifier.fillMaxWidth()) {
            ...
            if (viewModel.punchScore != null) {
                LabeledPieChart(
                    ...
                    centerLabel = stringResource(id = R.string.result_unit_score, viewModel.punchScore!!),
            ...
            if (viewModel.kickScore != null) {
                LabeledPieChart(
                    ...
                    centerLabel = stringResource(id = R.string.result_unit_score, viewModel.kickScore!!),
                    modifier = Modifier.weight(0.5f),
