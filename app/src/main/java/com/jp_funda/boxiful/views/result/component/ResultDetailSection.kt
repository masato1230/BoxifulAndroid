...
@Composable
fun ResultDetailSection(result: SingleMenuScores) {
    Card(
        ...
        Column(modifier = Modifier.padding(10.dp)) {
            ...
            // Great count
            Text(
                text = "${stringResource(id = R.string.great)} ${stringResource(id = R.string.result_times)}",
                color = Pink500,
                fontWeight = FontWeight.ExtraBold,
            ...
            // Good count
            Text(
                text = "${stringResource(id = R.string.good)} ${stringResource(id = R.string.result_times)}",
                color = Blue500,
                fontWeight = FontWeight.ExtraBold,
            ...
            // Miss count
            Text(
                text = "${stringResource(id = R.string.miss)} ${stringResource(id = R.string.result_times)}",
                color = Color.Gray,
                fontWeight = FontWeight.ExtraBold,
                modifier = Modifier.padding(start = 20.dp, bottom = 5.dp)
            )
